...
-------------------------------------------------------------------------------------------------------------------------
function Draw3DText(x,y,z,textInput,fontId,scaleX,scaleY, colorR, colorG, colorB, colorAlpha)
	 ...
	 SetTextColour(colorR, colorG, colorB, colorAlpha)		-- You can change the text color here
	 SetTextDropshadow(1, 1, 1, 1, colorAlpha)
